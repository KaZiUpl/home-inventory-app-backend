define({ "api": [
  {
    ...
    "description": "<p>Deletes user with provided id from collaborators list. Can be used either by main container's owner or one of its collaborators in order to remove oneself from collaborating.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    "type": "get",
    "url": "/houses/:id",
    "title": "Get main container (house) info.",
    "name": "GetHouseInfo",
    "group": "House",
    "permission": [
      {
        "name": "main container's owner or collaborators"
      }
    ],
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>ID of the main container (house)</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "type": "get",
    "url": "/houses",
    "title": "Get list of user's main containers (houses).",
    "name": "GetHouseList",
    "group": "House",
    "permission": [
      {
  ...
  },
  {
    "type": "post",
    "url": "/houses",
    "title": "Create new main container (house)",
    "name": "PostHouse",
    "group": "House",
    "permission": [
      {
  ...
  },
  {
    "type": "put",
    "url": "/houses/:id",
    "title": "Modify main container (house) info.",
    "name": "PutHouseInfo",
    "group": "House",
    "permission": [
      {
